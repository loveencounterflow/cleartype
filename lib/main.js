(function() {
  'use strict';
  var Cleartype, Cleartype_error, Cleartype_validation_error, TMP_typespace1, bind_instance_methods, ct, ct_kinds, debug, get_instance_methods, help, hide, primitive_types, rpr, type_of;
  ...
  (() => {    // #===========================================================================================================
    ...
    var CT;
    CT = new Cleartype();
    return module.exports = {Cleartype, TMP_typespace1, CT, ...(get_instance_methods(CT))};
  })();
