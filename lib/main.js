(function() {
  'use strict';
  var Cleartype_arguments_not_allowed_error, Cleartype_creation_error, Cleartype_error, Cleartype_kind_error, Cleartype_validation_error, Internals, Type, Typespace, bind_instance_methods, debug, gnd, help, hide, internals, nameit, rpr, std, type, type_of, validate, warn;
  ...
  Cleartype_kind_error = class Cleartype_kind_error extends Cleartype_error {};
  ...
  Type = (function() {
    ...
    class Type {
      ...
      create(typename, dcl) {
        ...
        //.......................................................................................................
        create = function() {
          throw new Cleartype_creation_error(`Ω___3 unable to create a ${dcl.name}`);
        };
        if (dcl.create != null) {
      ...
      _compile_base(dcl) {
        ...
        if (dcl.base != null) {
          if (!(dcl.base instanceof this.constructor)) {
            /* TAINT use `type_of()` */
            throw new Error(`Ω___6 dcl.base must be instanceof ${rpr(this)}, got ${rpr(dcl.base)}`);
          }
          has_base = true;
          base = dcl.base;
...
//.......................................................................................................
      ...
      _compile_template(dcl) {
        var has_template, sources, template;
        has_template = false;
      ...
      validate(x) {
        ...
        throw new Cleartype_validation_error(`Ω___9 validation error: expected a ${this.name}, got a ${type_of(x)}`);
      }
