...
//.......................................................................................................
      ...
      _compile_create(dcl) {
        var create;
        create = function() {
          throw new Cleartype_nocreate_error(`Ω__11 unable to create a ${dcl.name}`);
        };
        if (dcl.create != null) {
      ...
      validate(x) {
        ...
        throw new Cleartype_type_validation_error(`Ω__14 validation error: expected a ${this.name}, got a ${type_of(x)}`);
      }
