    ...
    class Type {
      ...
      constructor() {
        if (arguments.length !== 0) {
          throw new E.Cleartype_arguments_not_allowed_error("Ω___2 arguments not allowed");
        }
...
//.......................................................................................................
        for (hint_reason in hints) {
          ...
          throw new E.Cleartype_kind_mismatch_error(`Ω___4 according to ${dcl.name}.${kind_reason}, ` + `the kind of ${dcl.name} is ${rpr(kind)}, but according to ${dcl.name}.${hint_reason}, ` + `the kind of ${dcl.name} is ${rpr(hint)}`);
        }
        //.......................................................................................................
        return {kind};
      }
...
//.......................................................................................................
      ...
      _compile_template(dcl) {
        ...
        get_template = function() {
          throw new E.Cleartype_notemplate_error(`Ω___6 type ${dcl.name} doesn't have a template`);
        };
        //.......................................................................................................
        if (has_template) {
        ...
        //.......................................................................................................
        } else if (dcl.has_base && dcl.base.has_template) {
      ...
      _compile_create(dcl) {
        var create;
        create = function() {
          throw new E.Cleartype_nocreate_error(`Ω__12 unable to create a ${dcl.name}`);
        };
        if (dcl.create != null) {
      ...
      validate(x) {
        ...
        throw new E.Cleartype_type_validation_error(`Ω__15 validation error: expected a ${this.name}, got a ${type_of(x)}`);
      }
